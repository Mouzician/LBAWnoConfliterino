...
<body >
	...
	<div id="form_container">
		...
		<form role ="form" action ="{$BASE_URL}actions/users/comprar.php" method="post">				
    <ul >
		...
		<div>
			<input id="element_2" name="element_2" class="element text medium" type="text" maxlength="255" value="{$dados.email}" required readonly/> 
		</div> 
		</li>		<li id="li_3" >
...
<option value="{$dados.pais}" selected>{$dados.pais}</option>
